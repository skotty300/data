...
function init_gear_sets()
    ...
    sets.precast.FC = {main="Akademos",sub="Vivid Strap",ammo="Impatiens",
        head="Amalric coif",neck="Baetyl pendant",ear1="Loquacious Earring",ear2="Etiolation Earring",
        body="Shango robe",hands="Gendewitha gages",ring1="Prolix Ring",ring2="Weatherspoon ring",
    ...
    sets.midcast.FastRecast = {ammo="Sapience orb",
        head="Amalric coif",neck="Baetyl pendant",ear1="Loquacious Earring",ear2="Etiolation Earring",
        body="Helios jacket",hands="Helios gloves",ring1="Kishar Ring",ring2="Weatherspoon ring",
    ...
    sets.midcast.Cure = {main="Akademos",sub="Niobid Strap",ammo="Sapience orb",
        head="Gendewitha Caubeen",neck="Colossus's Torque",ear1="Mendicant's earring",ear2="Loquacious Earring",
        body="Vanya robe",hands="Telchine Gloves",ring1="Prolix Ring",ring2="Sirona's Ring",
        back="Solemnity Cape",waist="Gishdubar sash",legs="Gyve trousers",feet="Chironic slippers"}
    ...
    sets.midcast.Regen = {main="Bolelabunga",head="Arbatel Bonnet",body="Telchine Chasuble",hands="Telchine gloves",
    ...
    sets.midcast.MndEnfeebles = {main="Akademos",sub="Niobid Strap",ammo="Kalboron stone",
        head="Amalric coif",neck="Imbodla necklace",ear1="Barkarole Earring",ear2="Gwati Earring",
        body="Vanya Robe",hands="Chironic gloves",ring1="Vertigo Ring",ring2="Weatherspoon Ring",
        back="Aurist's cape",waist="Eschan stone",legs="Chironic hose",feet="Chironic slippers"}

    sets.midcast.IntEnfeebles = {main="Akademos",sub="Niobid Strap",ammo="Kalboron stone",
        head="Amalric coif",neck="Imbodla necklace",ear1="Barkarole Earring",ear2="Gwati Earring",
        body="Vanya Robe",hands="Chironic gloves",ring1="Vertigo Ring",ring2="Weatherspoon Ring",
        back="Aurist's cape",waist="Eschan stone",legs="Chironic hose",feet="Chironic slippers"}
    ...
    sets.midcast['Dark Magic'] = {main="Akademos",sub="Niobid Strap",ammo="Kalboron stone",
        head="Merlinic hood",neck="Sanctity necklace",ear1="Barkarole Earring",ear2="Gwati earring",
        body="Psycloth vest",hands="Chironic gloves",ring1="Vertigo Ring",ring2="Evanescence Ring",
        back="Refraction Cape",waist="Eschan stone",legs="Chironic hose",feet="Chironic slippers"}
    ...
    sets.midcast.Kaustra = {main="Akademos",sub="Niobid Strap",ammo="Ghastly tathlum +1",
        ...
        body="Amalric doublet",hands="Amalric gages",ring1="Vertigo Ring",ring2="Acumen Ring",
        back="Toro Cape",waist="Refoccilation Stone",legs="Merlinic Shalwar",feet="Chironic slippers"}

    sets.midcast.Drain = {main="Akademos",sub="Niobid Strap",ammo="Sapience orb",
        head="Merlinic hood",neck="Sanctity necklace",ear1="Psystorm Earring",ear2="Lifestorm Earring",
        body="Amalric doublet",hands="Chironic Gloves",ring1="Evanescence Ring",ring2="Sangoma Ring",
        back="Bookworm's Cape",waist="Fucho-no-obi",legs="Chironic hose",feet="Chironic slippers"}

    sets.midcast.Aspir = sets.midcast.Drain

    sets.midcast.Stun = {main="Akademos",sub="Niobid Strap",ammo="Kalboron stone",
        head="Merlinic hood",neck="Sanctity necklace",ear1="Psystorm Earring",ear2="Lifestorm Earring",
        body="Amalric doublet",hands="Amalric gages",ring1="Prolix Ring",ring2="Sangoma Ring",
    ...
    sets.midcast['Elemental Magic'] = {main="Akademos",sub="Niobid Strap",ammo="Ghastly tathlum +1",
        ...
        body="Amalric doublet",hands="Chironic gloves",ring1="Vertigo ring",ring2="Acumen Ring",
        back="Toro cape",waist="Refoccilation stone",legs="Merlinic Shalwar",feet="Chironic slippers"}
    ...
    sets.midcast['Elemental Magic'].Resistant = {main="Akademos",sub="Niobid Strap",ammo="Ghastly tathlum +1",
        ...
        back="Seshaw Cape",waist="Yamabuki-no-Obi",legs="Merlinic Shalwar",feet="Chironic slippers"}
    ...
    sets.midcast.Impact = {main="Akademos",sub="Niobid Strap",ammo="Ghastly tathlum +1",
        ...
        body="Twilight Cloak",hands="Amalric gages",ring1="Icesoul Ring",ring2="Sangoma Ring",
        back="Toro Cape",waist="Refoccilation stone",legs="Merlinic Shalwar",feet="Chironic slippers"}
    ...
    sets.idle.Town = {main="Akademos",sub="Niobid Strap",ammo="Homiliary",
        head="Merlinic hood",neck="Sanctity necklace",ear1="Infused Earring",ear2="Etiolation Earring",
    ...
    sets.idle.Field = {main="Akademos",sub="Niobid Strap",ammo="Homiliary",
        head="Merlinic hood",neck="Sanctity necklace",ear1="Infused Earring",ear2="Etiolation Earring",
        body="Amalric doublet",hands="Serpentes cuffs",ring1="Sheltered Ring",ring2="Paguroidea Ring",
        back="Solemnity cape",waist="Hierarch Belt",legs="Assiduity pants +1",feet="Serpentes Sabots"}
    ...
    sets.idle.Field.Stun = {main="Akademos",sub="Niobid Strap",ammo="Sapience orb",
        ...
        body="Amalric doublet",hands="Gendewitha Gages +1",ring1="Prolix Ring",ring2="Sangoma Ring",
    ...
    sets.idle.Weak = {main="Bolelabunga",sub="Genmei Shield",ammo="Homiliary",
        head="Amalric coif",neck="Wiglen Gorget",ear1="Bloodgem Earring",ear2="Loquacious Earring",
        body="Amalric doublet",hands="Chironic Gloves",ring1="Sheltered Ring",ring2="Meridian Ring",
