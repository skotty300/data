...
function init_gear_sets()
    ...
    sets.precast.WS['Cataclysm'] = {
        ...
        back="Toro Cape",waist="Fotia Belt",legs="Nahtirah Trousers",feet="Qaaxo Leggings"}
    ...
    sets.idle = {ammo="Thew Bomblet",
        head="Felistris Mask",neck="Wiglen Gorget",ear1="Brutal Earring",ear2="Sherida Earring",
        body="Hizamaru Haramaki +2",hands="Hesychast's Gloves +1",ring1="Sheltered Ring",ring2="Paguroidea Ring",
        back="Iximulew Cape",waist="Black Belt",legs="Mummu Kecks +2",feet="Herald's Gaiters"}
    ...
    sets.idle.Town = {ammo="Thew Bomblet",
        ...
        back="Atheling Mantle",waist="Black Belt",legs="Mummu Kecks +2",feet="Herald's Gaiters"}
    ...
    sets.defense.PDT = {ammo="Iron Gobbet",
        head="Uk'uxkaj Cap",neck="Loricate Torque +1",
        body="Otronif Harness +1",hands="Otronif Gloves",ring1="Defending Ring",ring2=gear.DarkRing.physical,
        back="Moonbeam Cape",waist="Black Belt",legs="Mummu Kecks +2",feet="Otronif Boots +1"}

    sets.defense.HP = {ammo="Iron Gobbet",
        head="Uk'uxkaj Cap",neck="Lavalier +1",ear1="Brutal Earring",ear2="Sherida Earring",
        body="Hesychast's Cyclas",hands="Hesychast's Gloves +1",ring1="K'ayres Ring",ring2="Meridian Ring",
        back="Moonbeam Cape",waist="Black Belt",legs="Hesychast's Hose +1",feet="Hesychast's Gaiters +1"}

    sets.defense.MDT = {ammo="Demonry Stone",
        head="Uk'uxkaj Cap",neck="Loricate Torque +1",
        body="Otronif Harness +1",hands="Anchorite's Gloves +1",ring1="Defending Ring",ring2="Shadow Ring",
        back="Engulfer Cape",waist="Black Belt",legs="Mummu Kecks +2",feet="Daihanshi Habaki"}
    ...
    sets.engaged.SomeAcc = {ammo="Honed Tathlum",
        head="Taeon Chapeau",neck="Asperity Necklace",ear1="Brutal Earring",ear2="Sherida Earring",
        body="Adhemar Jacket",hands="Hesychast's Gloves",ring1="Hetairoi Ring",ring2="Epona's Ring",
        back="Segomo's Mantle",waist="Windbuffet Belt +1",legs="Samnuha Tights",feet="Herculean Boots"}
    sets.engaged.Acc = {ammo="Honed Tathlum",
        head="Mummu Bonnet +2",neck="Sanctity Necklace",ear1="Brutal Earring",ear2="Sherida Earring",
    ...
    sets.engaged.Footwork = {ammo="Thew Bomblet",
        head="Felistris Mask",neck="Asperity Necklace",ear1="Brutal Earring",ear2="Sherida Earring",
        body="Qaaxo Harness",hands="Hesychast's Gloves +1",ring1="Hetairoi Ring",ring2="Epona's Ring",
    ...
    sets.engaged.Footwork.Acc = {ammo="Honed Tathlum",
        head="Whirlpool Mask",neck="Asperity Necklace",ear1="Brutal Earring",ear2="Sherida Earring",
        body="Otronif Harness +1",hands="Hesychast's Gloves +1",ring1="Hetairoi Ring",ring2="Epona's Ring",
