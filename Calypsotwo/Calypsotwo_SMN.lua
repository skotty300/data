...
function user_setup()
	...
	gear.pet_melee_back = { name="Campestres's Cape", augments={'Pet: Acc.+20 Pet: R.Acc.+20 Pet: Atk.+20 Pet: R.Atk.+20','Pet: Attack+10 Pet: Rng.Atk.+10','Pet: Haste+10',}}
	gear.bp_magical_hands = { name="Merlinic Dastanas", augments={'Blood Pact Dmg.+10','Pet: INT+8','Pet: Mag. Acc.+11','Pet: "Mag.Atk.Bns."+9',}}
	gear.bp_physical_hands = { name="Merlinic Dastanas", augments={'Pet: Attack+26 Pet: Rng.Atk.+26','Blood Pact Dmg.+9','Pet: DEX+8','Pet: "Mag.Atk.Bns."+12',}}
    gear.bp_physical_legs = { name="Apogee Slacks", augments={'Pet: STR+15','Blood Pact Dmg.+13','Pet: "Dbl. Atk."+3',}}
...
function init_gear_sets()
    ...
    sets.precast.JA['Elemental Siphon'] = {
        ...
        back="Conveyance Cape",legs="Beckoner's Spats +1",feet="Caller's Pigaches +2"}
    ...
    sets.precast.FC = {
        ...
        body="Inyanga jubbah +1",ring1="Kishar Ring",ring2="Lebeche Ring",
        back="Perimede Cape",waist="Witful Belt",legs="Artsieq Hose",feet="Chelona Boots"}
    ...
    sets.precast.WS = {
        head="Merlinic Hood",neck="Fotia Gorget",ear1="Friomisi Earring",ear2="Ishvara Earring",
        body="Amalric Doublet",hands="Amalric Gages",ring1="Shiva Ring +1",ring2="Acumen Ring",
        back="Pahtli Cape",waist="Fotia Belt",legs="Merlinic Shalwar",feet="Merlinic Crackows"}
    ...
    sets.midcast.Cure = {main="Tamaxchi",sub="Genbu's Shield",
        ...
        back="Swith Cape",waist="Witful Belt",legs="Chironic Hose",feet="Hagondes Sabots"}
    ...
    sets.midcast.Pet.BloodPactWard = {main="Nirvana",ammo="Sancus Sachet",
        head="Convoker's Horn +2",neck="Caller's Pendant",
        body="Caller's Doublet +2",hands="Glyphic Bracers +1",ring1="Evoker's Ring",ring2="Fervor Ring",
        waist="Diabolos's Rope",legs="Marduk's Shalwar +1"}

    sets.midcast.Pet.DebuffBloodPactWard = {main="Nirvana",ammo="Sancus Sachet",
        head="Convoker's Horn +2",neck="Caller's Pendant",
        body="Caller's Doublet +2",hands="Glyphic Bracers +1",ring1="Evoker's Ring",ring2="Fervor Ring",
        waist="Diabolos's Rope",legs="Marduk's Shalwar +1"}
    ...
    sets.resting = {main=gear.Staff.HMP,ammo="Sancus Sachet",
        head="Convoker's Horn +2",neck="Wiglen Gorget",ear1="Gifted Earring",ear2="Loquacious Earring",
        body="Shomonjijoe",hands="Serpentes Cuffs",ring1="Sheltered Ring",ring2="Paguroidea Ring",
        back="Pahtli Cape",waist="Austerity Belt",legs="Nares Trews",feet="Chelona Boots"}
    
    -- Idle sets
    sets.idle = {main="Owleyes",sub="Genbu's Shield",ammo="Sancus Sachet",
        head="Convoker's Horn +2",neck="Loricate Torque +1",ear1="Gifted Earring",ear2="Loquacious Earring",
        body="Shomonjijoe",hands="Serpentes Cuffs",ring1="Sheltered Ring",ring2="Defending Ring",
        back="Moonbeam Cape",waist="Fucho-no-Obi",legs="Assid. Pants +1",feet="Herald's Gaiters"}

    sets.idle.PDT = {main=gear.Staff.PDT,sub="Achaq Grip",ammo="Sancus Sachet",
        head="Convoker's Horn +2",neck="Twilight Torque",ear1="Gifted Earring",ear2="Loquacious Earring",
        body="Shomonjijoe",hands="Yaoyotl Gloves",ring1="Defending Ring",ring2="Sangoma Ring",
        back="Moonbeam Cape",waist="Fucho-no-Obi",legs="Hagondes Pants",feet="Herald's Gaiters"}
    ...
    sets.idle.Avatar = {main="Nirvana",sub="Elan Strap",ammo="Sancus Sachet",
        head="Convoker's Horn +2",neck="Caller's Pendant",ear1="Gifted Earring",ear2="Evans Earring",
        body="Shomonjijoe",hands="Serpentes Cuffs",ring1="Evoker's Ring",ring2="Sangoma Ring",
        back="Conveyance Cape",waist="Isa Belt",legs="Assid. Pants +1",feet="Apogee Pumps"}

    sets.idle.PDT.Avatar = {main="Nirvana",sub="Elan Strap",ammo="Sancus Sachet",
        head="Convoker's Horn +2",neck="Caller's Pendant",ear1="Gifted Earring",ear2="Loquacious Earring",
        body="Shomonjijoe",hands="Regimen Mittens",ring1="Evoker's Ring",ring2="Defending Ring",
        back="Conveyance Cape",waist="Fucho-no-Obi",legs="Hagondes Pants",feet="Convoker's Pigaches"}

    sets.idle.Spirit = {main="Nirvana",sub="Achaq Grip",ammo="Sancus Sachet",
        head="Convoker's Horn +2",neck="Caller's Pendant",ear1="Gifted Earring",ear2="Loquacious Earring",
        body="Shomonjijoe",hands="Serpentes Cuffs",ring1="Evoker's Ring",ring2="Sangoma Ring",
        back="Tiresias'' Cape",waist="Fucho-no-Obi",legs="Summoner's Spats",feet="Herald's Gaiters"}

    sets.idle.Town = {main="Owleyes",sub="Genbu's Shield",ammo="Sancus Sachet",
        head="Convoker's Horn +2",neck="Loricate Torque +1",ear1="Gifted Earring",ear2="Loquacious Earring",
    ...
    sets.idle.Avatar.Melee = {hands="Regimen Mittens",back="Tiresias'' Cape",waist="Kuku Stone",legs="Convoker's Spats"}
        
    sets.perp = {}
    -- Caller's Bracer's halve the perp cost after other costs are accounted for.
    -- Using -10 (Gridavor, ring, Conv.feet), standard avatars would then cost 5, halved to 2.
    -- We can then use Apogee dalmatica and end up with the same net MP cost, but significantly better defense.
    -- Weather is the same, but we can also use the latent on the pendant to negate the last point lost.
    sets.perp.Day = {body="Apogee dalmatica",hands="Caller's Bracers +2"}
    sets.perp.Weather = {neck="Caller's Pendant",body="Apogee dalmatica",hands="Caller's Bracers +2"}
    -- Carby: Mitts+Conv.feet = 1/tick perp.  Everything else should be +refresh
    sets.perp.Carbuncle = {head="Convoker's Horn +2",body="Apogee dalmatica",hands="Carbuncle Mitts",legs="Assid. Pants +1",feet="Convoker's Pigaches"}
    ...
    sets.defense.PDT = {main=gear.Staff.PDT,
        ...
        body="Shomonjijoe",hands="Yaoyotl Gloves",ring1="Defending Ring",ring2=gear.DarkRing.physical,
        back="Moonbeam Cape",waist="Fucho-no-Obi",legs="Hagondes Pants",feet="Hagondes Sabots"}

    sets.defense.MDT = {
        head="Hagondes Hat",neck="Twilight Torque",ear1="Gifted Earring",ear2="Loquacious Earring",
        body="Shomonjijoe",hands="Yaoyotl Gloves",ring1="Defending Ring",ring2="Shadow Ring",
        back="Moonbeam Cape",waist="Fucho-no-Obi",legs="Bokwus Slops",feet="Hagondes Sabots"}
    ...
    sets.engaged = {ammo="Sancus Sachet",
        ...
        body="Tali'ah Manteel +1",hands="Tali'ah Gages +1",ring1="Rajas Ring",ring2="Petrov Ring",
        back="Moonbeam Cape",waist="Windbuffet belt +1",legs="Assid. Pants +1",feet="Tali'ah Crackows +1"}
end
