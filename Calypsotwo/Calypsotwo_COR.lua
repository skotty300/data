...
function user_setup()
	...
	gear.melee_cape = { name="Camulus's Mantle", augments={'DEX+20','Accuracy+20 Attack+20','"Dbl.Atk."+10',}}
...
function init_gear_sets()
    ...
    sets.precast.RA = {ammo=gear.RAbullet,
        ...
        back=gear.ranged_cape,waist="Yemaya Belt",legs="Laksamana's Trews +2",feet="Meghanada Jambeaux +2"}
    ...
    sets.precast.WS['Wildfire'] = {ammo=gear.MAbullet,
        ...
        body="Lanun Frac +3",hands="Meghanada Gloves +2",ring1="Ilabrat Ring",ring2="Dingir Ring",
    ...
    sets.midcast.CorsairShot = {ammo=gear.QDbullet,
        ...
        body="Samnuha Coat",hands="Mummu Wrists +2",ring1="Regal Ring",ring2="Dingir Ring",
        back=gear.ls_cape,waist="Eschan Stone",legs="Meghanada Chausses +2",feet="Laksamana's Boots +2"}
    ...
    sets.midcast.CorsairShot['Light Shot'] = {ammo=gear.QDbullet,
        ...
        body="Mummu Jacket +2",hands="Laskamana's Gants +2",ring1="Regal Ring",ring2="Dingir Ring",
        back=gear.ranged_cape,waist="Eschan Stone",legs="Mummu Kecks +2",feet="Laksamana's Boots +2"}
    ...
    sets.midcast.RA = {ammo=gear.RAbullet,
        head="Meghanada Visor +2",neck="Iskur Gorget",ear1="Enervating Earring",ear2="Volley Earring",
        body="Mummu Jacket +2",hands="Meghanada Gloves +2",ring1="Ilabrat Ring",ring2="Dingir Ring",
	...
	sets.midcast.TS = {ammo=gear.RAbullet,
		...
		body="Chasseur's Frac +1",hands="Meghanada Gloves +2",ring1="Ilabrat Ring",ring2="Dingir Ring",
		back=gear.ranged_cape,waist="Yemaya Belt",legs="Meghanada Chausses +2",feet="Meghanada Jambeaux +2"}   
    ...
    sets.idle.Town = {ammo=gear.RAbullet,
        head="Lanun Tricorne +2",neck="Loricate Torque +1",ear1="Ethereal Earring",ear2="Etiolation Earring",
        body="Lanun Frac +3",hands="Meghanada Gloves +2",ring1="Sheltered Ring",ring2="Paguroidea Ring",
        back="Moonbeam Cape",waist="Flume Belt",legs="Carmine Cuisses +1",feet="Lanun Bottes +3"}
    ...
    sets.engaged.Melee = {ammo=gear.RAbullet,
        ...
        back=gear.melee_cape,waist="Windbuffet Belt +1",legs="Samnuha Tights",feet=gear.FeetMeleeAcc}
    
    sets.engaged.Acc = {ammo=gear.RAbullet,
        head="Dampening Tam",neck="Sanctity Necklace",ear1="Cessance Earring",ear2="Brutal Earring",
        body="Adhemar Jacket",hands="Herculean Gloves",ring1="Patricius Ring",ring2="Ilabrat Ring",
        back=gear.melee_cape,waist="Kentarch Belt +1",legs="Carmine Cuisses +1",feet=gear.FeetMeleeAcc}

    sets.engaged.DW = {ammo=gear.RAbullet,
        head="Adhemar Bonnet",neck="Iskur Gorget",ear1="Cessance Earring",ear2="Suppanomimi Earring",
        body="Adhemar Jacket",hands="Herculean Gloves",ring1="Petrov Ring",ring2="Epona's Ring",
        back=gear.melee_cape,waist="Windbuffet Belt +1",legs="Samnuha Tights",feet=gear.FeetMeleeAcc}
    
    sets.engaged.DWAcc = {ammo=gear.RAbullet,
        head="Dampening Tam",neck="Sanctity Necklace",ear1="Cessance Earring",ear2="Suppanomimi Earring",
        body="Adhemar Jacket",hands="Herculean Gloves",ring1="Patricius Ring",ring2="Ilabrat Ring",
        back=gear.melee_cape,waist="Kentarch Belt +1",legs="Carmine Cuisses +1",feet=gear.FeetMeleeAcc}
end
