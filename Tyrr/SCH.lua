...
function init_gear_sets()
    ...
    sets.precast.FC = {main="Akademos",sub="Vivid Strap",ammo="Incantor stone",
    ...
    sets.midcast.Cure = {main="Akademos",sub="Niobid Strap",ammo="Incantor Stone",
        head="Vanya hood",neck="Colossus's Torque",ear1="Mendicant's earring",ear2="Loquacious Earring",
        body="Heka's Kalasiris",hands="Bokwus Gloves",ring1="Prolix Ring",ring2="Sirona's Ring",
        back="Swith Cape",waist="Goading Belt",legs="Chironic hose",feet="Academic's Loafers +1"}

    sets.midcast.CureWithLightWeather = {main="Akademos",sub="Niobid Strap",ammo="Incantor Stone",
    ...
    sets.midcast.Regen = {main="Bolelabunga",sub="Ammurapi Shield",ammo="Savant's Treatise",
        head="Telchine cap",neck="Incanter's Torque",
        body="Telchine chasuble",hands="Telchine gloves",back="Perimede Cape",
    ...
    sets.midcast.MndEnfeebles = {main="Akademos",sub="Niobid Strap",ammo="Hydrocera",
        ...
        body="Vanya Robe",hands="Chironic Gloves",ring1="Vertigo Ring",ring2="Sangoma Ring",
        back="Aurist's cape",waist="Demonry Sash",legs="Chironic hose",feet="Uk'uxkaj boots"}

    sets.midcast.IntEnfeebles = {main="Akademos",sub="Niobid Strap",ammo="Hydrocera",
        head="Nahtirah Hat",neck="Incanter's Torque",ear1="Barkarole Earring",ear2="Gwati Earring",
        body="Vanya Robe",hands="Chironic Gloves",ring1="Vertigo Ring",ring2="Sangoma Ring",
        back="Aurist's cape",waist="Demonry Sash",legs="Chironic hose",feet="Uk'uxkaj boots"}
    ...
    sets.midcast['Dark Magic'] = {main="Akademos",sub="Niobid Strap",ammo="Incantor Stone",
        head="Nahtirah Hat",neck="Incanter's Torque",ear1="Barkarole Earring",ear2="Lifestorm Earring",
        body="Helios jacket",hands="Chironic Gloves",ring1="Strendu Ring",ring2="Sangoma Ring",
        back="Refraction Cape",waist="Goading Belt",legs="Psycloth Lappas",feet="Merlinic crackows"}

    sets.midcast.Kaustra = {main="Akademos",sub="Niobid Strap",ammo="Ghastly tathlum +1",
        head="Merlinic Hood",neck="Sanctity Necklace",ear1="Hecate's Earring",ear2="Friomisi Earring",
        body="Amalric doublet",hands="Chironic Gloves",ring1="Shiva Ring +1",ring2="Acumen Ring",
        back="Toro Cape",waist="Refoccilation Stone",legs="Merlinic Shalwar",feet="Merlinic crackows"}

    sets.midcast.Drain = {main="Akademos",sub="Niobid Strap",ammo="Incantor Stone",
        head="Nahtirah Hat",neck="Incanter's Torque",ear1="Psystorm Earring",ear2="Gwati Earring",
        body="Helios jacket",hands="Chironic Gloves",ring1="Evanescence Ring",ring2="Sangoma Ring",
        back="Bookworm's Cape",waist="Fucho-no-obi",legs="Pedagogy Pants",feet="Merlinic Crackows"}

    sets.midcast.Aspir = sets.midcast.Drain

    sets.midcast.Stun = {main="Akademos",sub="Niobid Strap",ammo="Incantor Stone",
        head="Peda. M.Board +1",neck="Erra Pendant",ear1="Regal Earring",ear2="Gwati Earring",
        body="Academic's Gown +2",hands="Academic's Bracers +2",ring1="Stikini Ring",ring2="Stikini Ring",
        back="Lugh's Cape",waist="Luminary Sash",legs={ name="Merlinic Shalwar", augments={'Mag. Acc.+21 "Mag.Atk.Bns."+21','Magic burst dmg.+6%','Mag. Acc.+2','"Mag.Atk.Bns."+11',}},
    ...
    sets.midcast['Elemental Magic'] = {main="Akademos",sub="Niobid Strap",ammo="Pemphredo Tathlum",
        ...
        body={ name="Merlinic Jubbah", augments={'Mag. Acc.+23 "Mag.Atk.Bns."+23','Magic burst dmg.+10%','Mag. Acc.+9',}},
		hands={ name="Chironic Gloves", augments={'Mag. Acc.+24 "Mag.Atk.Bns."+24','"Drain" and "Aspir" potency +7','Mag. Acc.+10','"Mag.Atk.Bns."+8',}},
		ring1="Acumen Ring",ring2="Shiva Ring +1",back={ name="Lugh's Cape", augments={'INT+20','Mag. Acc+20 /Mag. Dmg.+20','"Mag.Atk.Bns."+10',}},waist="Yamabuki-no-Obi",
		feet={ name="Merlinic Crackows", augments={'"Mag.Atk.Bns."+30','Magic burst dmg.+5%','MND+7','Mag. Acc.+13',}}}

    sets.midcast['Elemental Magic'].Resistant = {main="Akademos",sub="Niobid Strap",ammo="Ghastly tathlum +1",
        head="Merlinic hood",neck="Incanter's Torque",ear1="Barkarole Earring",ear2="Friomisi Earring",
        body="Arbatel gown",hands="Chironic Gloves",ring1="Mujin Band",ring2="Locus Ring",
    ...
    sets.midcast.Impact = {main="Akademos",sub="Niobid Strap",ammo="Ghastly tathlum +1",
	...
	sets.midcast.Helix = set_combine(sets.midcast['Elemental Magic'], {back={ name="Lugh's Cape", augments={'INT+20','Mag. Acc+20 /Mag. Dmg.+20','"Mag.Atk.Bns."+10',}}})
    ...
    sets.idle.Town = {main="Akademos",sub="Niobid Strap",ammo="Homiliary",
        head="Merlinic hood",neck="Loricate Torque +1",ear1="Bloodgem Earring",ear2="Loquacious Earring",
        body="Councilor's garb",hands="Arbatel Bracers +1",ring1="Sheltered Ring",ring2="Paguroidea Ring",
        back="Moonbeam Cape",waist="Slipor Sash",legs="Arbatel Pants",feet="Herald's Gaiters"}

    sets.idle.Field = {main="Akademos",sub="Niobid Strap",ammo="Homiliary",
        head="Befouled Crown",neck="Loricate Torque +1",ear1="Bloodgem Earring",ear2="Loquacious Earring",
        body="Jhakri Robe +2",hands="Serpentes Cuffs",ring1="Sheltered Ring",ring2="Paguroidea Ring",
        back="Moonbeam Cape",waist="Slipor Sash",legs="Assiduity pants +1",feet="Herald's Gaiters"}

    sets.idle.Field.PDT = {main="Akademos",sub="Niobid Strap",ammo="Staunch Tathlum",
        ...
        back="Moonbeam Cape",waist="Slipor Sash",legs="Artsieq Hose",feet="Herald's Gaiters"}

    sets.idle.Field.Stun = {main="Akademos",sub="Enki Strap",ammo="Incantor Stone",
        head="Jhakri Coronal +2",neck="Incanter's Torque",left_ear="Barkaro. Earring",right_ear="Digni. Earring",
        body={ name="Merlinic Jubbah", augments={'Mag. Acc.+23 "Mag.Atk.Bns."+23','Magic burst dmg.+10%','Mag. Acc.+9',}},
		hands={ name="Chironic Gloves", augments={'Mag. Acc.+24 "Mag.Atk.Bns."+24','"Drain" and "Aspir" potency +7','Mag. Acc.+10','"Mag.Atk.Bns."+8',}},ring1="Prolix Ring",ring2="Sangoma Ring",
        back={ name="Lugh's Cape", augments={'INT+20','Mag. Acc+20 /Mag. Dmg.+20','"Mag.Atk.Bns."+10',}},waist="Luminary Sash",legs="Psycloth Lappas",feet="Jhakri pigaches +1"}

    sets.idle.Weak = {main="Bolelabunga",sub="Genmei Shield",ammo="Homiliary",
        head="Nahtirah Hat",neck="Loricate Torque +1",ear1="Bloodgem Earring",ear2="Loquacious Earring",
        body="Vanya Robe",hands="Chironic Gloves",ring1="Sheltered Ring",ring2="Meridian Ring",
        back="Moonbeam Cape",waist="Hierarch Belt",legs="Assiduity pants +1",feet="Herald's Gaiters"}

    -- Defense sets

    sets.defense.PDT = {main="Akademos",sub="Niobid Strap",ammo="Homiliary",
        head="Nahtirah Hat",neck="Loricate Torque +1",ear1="Bloodgem Earring",ear2="Loquacious Earring",
        body="Vanya Robe",hands="Gendewitha Gages +1",ring1="Defending Ring",ring2="Paguroidea Ring",
        back="Moonbeam Cape",waist="Isa belt",legs="Artsieq Hose",feet="Herald's Gaiters"}
    ...
    sets.defense.MDT = {main="Akademos",sub="Niobid Strap",ammo="Homiliary",
        ...
        back="Tuilha Cape",waist="Isa belt",legs="Psycloth Lappas",feet="Hagondes Sabots"}
    ...
    -- Normal melee group
    sets.engaged = {neck="Lissome Necklace",
	...
	sets.magic_burst = {main="Akademos",sub="Niobid Strap",ammo="Pemphredo Tathlum",
        head="Merlinic Hood",neck="Mizukage-no-Kubikazari",ear1="Barkarole Earring",ear2="Friomisi Earring",
        body="Merlinic Jubbah",
		hands="Amalric gages +1",ring1="Mujin Band",ring2="Shiva Ring +1",
        back={ name="Lugh's Cape", augments={'INT+20','Mag. Acc+20 /Mag. Dmg.+20','"Mag.Atk.Bns."+10',}},waist="Hachirin-no-Obi",legs="Merlinic Shalwar",
