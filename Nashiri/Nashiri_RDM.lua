function get_sets()
	...
	sets.idle = {
        ...
        back={ name="Mecisto. Mantle", augments={'Cap. Point+47%','HP+19','Mag. Acc.+3','DEF+5',}},
	} -- end sets.idle
	...
	sets.melee = {
        ...
        back={ name="Sucellos's Cape", augments={'DEX+20','Accuracy+20 Attack+20','Accuracy+9','"Dual Wield"+10',}},
	} -- end sets.melee
	...
	sets.midcast.magic.default = {
		...
		back={ name="Sucellos's Cape", augments={'INT+20','Mag. Acc+20 /Mag. Dmg.+20','Mag. Acc.+6','"Mag.Atk.Bns."+10',}},
	...
	sets.midcast.magic.enhancing = {
		...
		legs={ name="Telchine Braconi", augments={'"Cure" spellcasting time -2%','Enh. Mag. eff. dur. +8',}},
