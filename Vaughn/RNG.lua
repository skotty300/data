...
function init_gear_sets()
	...
	sets.precast.JA['Bounty Shot'] = {hands="Aimi Glovelettes"}
	...
	sets.precast.RA = {ammo="",
		head="Amini Gapette",neck="Ocachi Gorget",ear1="Flame Pearl",ear2="Flame Pearl",
		body="Amini Caban",hands="Manibozho Gloves",ring1="Hajduk Ring",ring2="Hajduk Ring",
		back="Lutian Cape",waist="Impulse Belt",legs="Arcadian Braccae +1",feet="Taeon Boots" }


	-- Weaponskill sets
	-- Default set for any weaponskill that isn't any more specifically defined
	sets.precast.WS = {ammo="",
		head="Orion beret +1",neck="Fotia Gorget",ear1="Flame Pearl",ear2="Flame Pearl",
		body="Orion Jerkin +1",hands="Arcadian Bracers +1",ring1="Pyrosoul Ring",ring2="Rajas Ring",
		back="Lutian Cape",waist="Fotia Belt",legs="Arcadian Braccae +1",feet="Arcadian Socks +1" }
    ...
    sets.precast.WS['Last Stand'] = {ammo="Achiyalabopa Bullet",
        head="Pursuer's Beret",neck="Fotia Gorget",ear1="Flame Pearl",ear2="Flame Pearl",
        body="Pursuer's Doublet",hands="Pursuer's Cuffs",ring1="Pyrosoul Ring",ring2="Rajas Ring",
        back="Lutian Cape",waist="Fotia Belt",legs="Pursuer's Pants",feet="Amini Bottillons"}
		    
	sets.precast.WS['Coronach'] = {ammo="Achiyalabopa Bullet",
        head="Pursuer's Beret",neck="Fotia Gorget",ear1="Flame Pearl",ear2="Flame Pearl",
        body="Pursuer's Doublet",hands="Pursuer's Cuffs",ring1="Pyrosoul Ring",ring2="Rajas Ring",
        back="Lutian Cape",waist="Fotia Belt",legs="Pursuer's Pants",feet="Amini Bottillons"}

	sets.precast.WS['Jishnus Radiance'] = {ammo="Achiyalabopa Arrow",
        head="Arcadian Beret +1",neck="Fotia Gorget",ear1="Flame Pearl",ear2="Flame Pearl",
        body="Pursuer's Doublet",hands="Despair Finger Gauntlets",ring1="K'ayres Ring",ring2="Rajas Ring",
        back="Lutian Cape",waist="Fotia Belt",legs="Darraigner's Brais",feet="Arcadian Socks +1"}
	...
	sets.midcast.RA = {
		head="Arcadian Beret +1",neck="Ocachi Gorget",ear1="Volley earring",ear2="Clearview Earring",
		body="Amini Caban",hands="Despair Fin. Gaunt.",ring1="Hajduk Ring",ring2="Hajduk Ring",
		back="Lutian Cape",waist="Scout's Belt",legs="Pursuer's Pants",feet="Amini Bottillons"}
	...
	-- Idle sets
	sets.idle = {
		head="Arcadian Beret +1",neck="Twilight Torque",ear1="Ethereal Earring",ear2="Infused Earring",
		body="Arcadian Jerkin +1",hands="Arcadian Bracers +1",ring1="Defending Ring",ring2="Vocane Ring",
		back="Shadow Mantle",waist="Flume Belt",legs="Crimson Cuisses",feet="Orion Socks +1"}
