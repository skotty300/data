...
function init_gear_sets()
    ...
    sets.precast.FC.Cure = set_combine(sets.precast.FC['Healing Magic'], {main="Tamaxchi",sub="Sors Shield",ammo="Impatiens"})
    ...
    sets.midcast.CureSolace = {main="Tamaxchi",sub="Sors Shield",ammo="Incantor Stone",
        head="Ebers Cap",neck="Orison Locket",ear1="Roundel Earring",ear2="Nourishing Earring",
        body="Ebers Briault",hands="Bokwus Gloves",ring1="Prolix Ring",ring2="Sirona's Ring",
        back="Tuilha Cape",waist=gear.ElementalObi,legs="Ebers Pantaloons",feet="Litany Clogs"}
    ...
    sets.midcast.CureMelee = {ammo="Incantor Stone",
        head="Gendewitha Caubeen",neck="Orison Locket",ear1="Roundel Earring",ear2="Nourishing Earring",
    ...
    sets.midcast.StatusRemoval = {main="Beneficus",sub="Sors Shield",
        head="Ebers Cap",neck="Malison Medallion",
        body="Ebers Bliaud",hands="Hieros Mittens",ring1="Ephedra Ring",ring2="Sirona's Ring",
        back="Mending Cape",waist="Goading Belt",legs="Theophany Pantaloons",feet="Gendewitha Galoshes"}
    ...
    sets.resting = {main=gear.Staff.HMP, 
        body="Respite Cloak",hands="Serpentes Cuffs",
    ...
    sets.idle = {main="Queller Rod", sub="Sors Shield",ammo="Incantor Stone",
        head="",neck="Wiglen Gorget",ear1="Bloodgem Earring",ear2="Loquacious Earring",
    ...
    sets.idle.PDT = {main="Tamaxchi", sub="Sors Shield",ammo="Incantor Stone",
        head="Gendewitha Caubeen",neck="Wiglen Gorget",ear1="Bloodgem Earring",ear2="Loquacious Earring",
        body="Ebers Bliaut",hands="Serpentes Cuffs",ring1="Sheltered Ring",ring2="Paguroidea Ring",
        back="Cheviot Cape",waist="Witful Belt",legs="Assiduity Pants +1",feet="Serpentes Sabots"}

    sets.idle.Town = {main="Tamaxchi", sub="Sors Shield",ammo="Incantor Stone",
        head="",neck="Wiglen Gorget",ear1="Bloodgem Earring",ear2="Loquacious Earring",
        body="Respite Cloak",hands="Serpentes Cuffs",ring1="Sheltered Ring",ring2="Paguroidea Ring",
        back="Cheviot Cape",waist="Witful Belt",legs="Assiduity Pants +1",feet="Serpentes Sabots"}
