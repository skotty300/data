...
function job_setup()
    ...
    random_lockstyle_list = {36,37,38,39}
...
function user_setup()
    ...
    state.JugMode = M{['description']='Jug Mode','Furious Broth','Fizzy Broth', 'Muddy Broth','Meaty Broth', 'Bubbly Broth', 'Spicy Broth',
        'Salubrious Broth', 'Windy Greens', 'Dire Broth', 'Swirling Broth', 'Vis. Broth', 'Livid Broth', 'Rapid Broth', 'Lyrical Broth', 'Bug-Ridden Broth','Electrified Broth','Trans. Broth'}
...
function init_gear_sets()
    ...
    Ready_Atk_Axe = { name="Kumbhakarna", augments={'Pet: Attack+23 Pet: Rng.Atk.+23','Pet: "Dbl.Atk."+4 Pet: Crit.hit rate +4','Pet: TP Bonus+200',}}
    Ready_Atk_Axe2 = { name="Arktoi", augments={'Accuracy+50','Pet: Accuracy+50','Pet: Attack+30',}}
    Ready_Atk_TPBonus_Axe = { name="Kumbhakarna", augments={'Pet: Attack+23 Pet: Rng.Atk.+23','Pet: "Dbl.Atk."+4 Pet: Crit.hit rate +4','Pet: TP Bonus+200',}}
    Ready_Atk_TPBonus_Axe2 = { name="Kumbhakarna", augments={'Pet: Attack+18 Pet: Rng.Atk.+18','Pet: "Dbl.Atk."+3 Pet: Crit.hit rate +3','Pet: TP Bonus+180',}}

    Ready_Acc_Axe = { name="Kumbhakarna", augments={'Pet: Attack+23 Pet: Rng.Atk.+23','Pet: "Dbl.Atk."+4 Pet: Crit.hit rate +4','Pet: TP Bonus+200',}}
    Ready_Acc_Axe2 = { name="Arktoi", augments={'Accuracy+50','Pet: Accuracy+50','Pet: Attack+30',}}
    Ready_Acc_TPBonus_Axe = { name="Kumbhakarna", augments={'Pet: Attack+23 Pet: Rng.Atk.+23','Pet: "Dbl.Atk."+4 Pet: Crit.hit rate +4','Pet: TP Bonus+200',}}
	Ready_Acc_TPBonus_Axe2 = { name="Kumbhakarna", augments={'Pet: Attack+18 Pet: Rng.Atk.+18','Pet: "Dbl.Atk."+3 Pet: Crit.hit rate +3','Pet: TP Bonus+180',}}
    ...
    Ready_Acc_body = "Heyoka Harness"
    Ready_Acc_hands = "Heyoka Mittens"
    Ready_Acc_legs = "Heyoka Subligar +1"
    Ready_Acc_feet = "Totemic Gaiters +3"
    ...
    MAB_hands = "Meg. Gloves +2"
    MAB_legs = { name="Valor. Hose", augments={'DEX+9','Accuracy+12','"Mag. Atk. Bns."+20','Weapon Skill Damage +2%',}}
    MAB_feet = { name="Valorous Greaves", augments={'Accuracy+7','"Mag. Atk. Bns."+20','Weapon Skill Damage +2%',}}

    FC_head = { name="Ankusa Helm +3", augments={'Enhances "Killer Instinct" effect',}}
    FC_body = "Jumalik Mail"
    FC_hands = "Meg. Gloves +2"
    FC_legs = "Tali'ah Sera. +2"
    FC_feet = "Tot. Gaiters +3"
    FC_back = DW_back
    ...
    MEva_Axe_sub = "Beatific Shield +1"
    ...
    sets.precast.JA.Tame = {head="Totemic Helm +2",ear1="Tamer's Earring",legs="Tot. Trousers +3"}
    ...
    sets.idle.Refresh = set_combine(sets.idle, {head="Jumalik Helm",body="Twilight Mail",legs="Stearc Subligar",ring1="Stikini Ring +1",ring2="Stikini Ring +1"})
    ...
    -------------------------------------------------------
    sets.IdleAxeShield = {main="Guttler",sub="Beatific Shield +1"}
    ...
    -----------------------------------------------------
    sets.IdleAxes = {main="Kaja Axe",sub="Blurred Axe +1"}
    ...
    sets.precast.WS['Bora Axe'] = {ammo="none",
        head="none",
		neck="none",
		ear1="none",
		ear2="none",
    ...
    sets.precast.Waltz = {ammo="Sonia's Plectrum",
        head="Totemic Helm +2",neck="Unmoving Collar +1",ear1="Handler's Earring +1",ear2="Enchanter Earring +1",
