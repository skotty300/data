...
function init_gear_sets()
    ...
    sets.precast.JA['Chakra'] = {ammo="Tantra Tathlum",
        head="Uk'uxkaj Cap",
        body="Anchorite's Cyclas +1",hands="Hesychast's Gloves",ring1="Terrasoul Ring", ring2="Terrasoul Ring",
        back="Oneiros Cappa",waist="Caudata Belt",legs="Ptronif brais",feet="Thurandaut Boots +1",
		ear1="Terra's Pearl", ear2="Soil Pearl", neck="Tjukurrpa medal"}
    ...
    sets.precast.WS = {ammo="Mantoptera eye",
        ...
        body="Abnoba kaftan",hands="Herculean Gloves",ring1="Rajas Ring",ring2="Epona's Ring",
        back="Atheling mantle",waist="Fotia belt",legs="Herculean trousers",feet="Herculean boots"}
    ...
    sets.precast.WS["Victory Smite"]   = set_combine(sets.precast.WS, {neck="Rancor Collar",back="Buquwik Cape",feet="Daihanshi Habaki"})
    ...
    sets.idle = {ammo="Thew Bomblet",
        ...
        back="Iximulew Cape",waist="Black Belt",legs="Otronif Brais",feet="Daihanshi Habaki"}
    ...
    sets.defense.PDT = {ammo="Iron Gobbet",
        ...
        body="Otronif Harness +1",hands="Otronif Gloves",ring1=gear.DarkRing.Magical,ring2=gear.DarkRing.physical,
        back="Shadow Mantle",waist="Black Belt",legs="Qaaxo Tights",feet="Otronif Boots"}
    ...
    sets.engaged = {ammo="Ginsen",
        head="Adhemar bonnet",neck="Clotharius torque",ear1="Bladeborn Earring",ear2="Steelflash Earring",
    ...
    sets.engaged.Acc = {ammo="Honed Tathlum",
        head="Whirlpool Mask",neck="Peacock Amulet",ear1="Bladeborn Earring",ear2="Steelflash Earring",
        body="Manibozho Jerkin",hands="Hesychast's Gloves +1",ring1="Raja's Ring",ring2="Mars's Ring",
        back="Letalis Mantle",waist="Hurch'lan Sash",legs="Manibozho Brais",feet="Daihanshi Habaki"}
    sets.engaged.Mod = {ammo="Thew Bomblet",
        ...
        body="Manibozho Jerkin",hands="Hesychast's Gloves +1",ring1="Rajas Ring",ring2="Mar's Ring",
        back="Atheling Mantle",waist="Windbuffet Belt +1",legs="Hesychast's Hose +1",feet="Anchorite's Gaiters +1"}
    ...
    sets.engaged.PDT = {ammo="Thew Bomblet",
        ...
        back="Atheling Mantle",waist="Black Belt",legs="Otronif Brais",feet="Otronif Boots"}
    sets.engaged.SomeAcc.PDT = {ammo="Honed Tathlum",
        head="Whirlpool Mask",neck="Peacock Amulet",ear1="Bladeborn Earring",ear2="Steelflash Earring",
        body="Thaumas Coat",hands="Hesychast's Gloves +1",ring1="Patricius Ring",ring2="Epona's Ring",
