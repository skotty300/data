...
function init_gear_sets()
        ...
        sets.precast.JA['Aggressor'] = {head="Pumm. Mask +2",body="Agoge Lorica +1"}
    ...
    back="Moonbeam Cape",
        ...
        sets.precast.WS.AccLow = {}
        sets.precast.WS.AccHigh = {}
        ...
        sets.precast.WS['Upheaval'].AccLow =  {
        sub="Utu Grip",
        ammo="Ginsen",
        head="Pummeler's Mask +2",
        body="Pumm. Lorica +2",
        ...
        sets.precast.WS['Upheaval'].AccHigh = {
        sub="Utu Grip",
        ammo="Ginsen",
        head="Pummeler's Mask +2",
        body="Pumm. Lorica +2",
        ...
        sets.precast.WS['Ukko\'s Fury'].AccLow = {
        sub="Utu Grip",
        ammo="Yetshila",
        head={ name="Argosy Celata", augments={'STR+10','DEX+10','Attack+15',}},
        body={ name="Argosy Hauberk", augments={'STR+10','Attack+15','"Store TP"+5',}},
        ...
        sets.precast.WS['Ukko\'s Fury'].AccHigh = {
        sub="Utu Grip",
        ammo="Ginsen",
        head="Pummeler's Mask +2",
        body="Pumm. Lorica +2",
        ...
        sets.precast.WS['Ukko\'s Fury'].Attack = {}
        sets.precast.WS['Ukko\'s Fury'].MS = {}
        ...
        sets.precast.WS['Metatron Torment'].AccLow = {}
        sets.precast.WS['Metatron Torment'].AccHigh = {}
    ...
    -- Gear to wear for kiting
        ...
        sets.engaged.AccHigh = {}
        sets.engaged.PDT = {}
        sets.engaged.AccLow.PDT = {}
