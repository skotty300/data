...
function init_gear_sets()
    ...
    sets.precast.WS = {main="Excalibur",ammo="Ginsen",
        head="Founder's Corona",neck="Fotia Gorget",ear1="Bladeborn Earring",ear2="Steelflash Earring",
        body="Founder's Breastplate",hands="Despair Finger Gauntlets",ring1="Ifirt Ring",ring2="Pyrosoul Ring",
        back="Atheling Mantle",waist="Fotia Belt",legs="Eschite Cuisses",feet="Loyalist Sabatons"}

    sets.precast.WS.Acc = {main="Excalibur",ammo="Ginsen",
        head="Founder's Corona",neck="Fotia Gorget",ear1="Bladeborn Earring",ear2="Steelflash Earring",
        body="Founder's Breastplate",hands="Despair Finger Gauntlets",ring1="Aquasoul Ring",ring2="Aquasoul Ring",
        back="Atheling Mantle",waist="Fotia Belt",legs="Eschite Cuisses",feet="Loyalist Sabatons"}

    -- Specific weaponskill sets.  Uses the base set if an appropriate WSMod version isn't found.
    sets.precast.WS['Requiescat'] = {main="Excalibur",ammo="Ginsen",
        head="Founder's Corona",neck="Fotia Gorget",ear1="Bladeborn Earring",ear2="Steelflash Earring",
        body="Founder's Breastplate",hands="Despair Finger Gauntlets",ring1="Aquasoul Ring",ring2="Aquasoul Ring",
        back="Atheling Mantle",waist="Fotia Belt",legs="Eschite Cuisses",feet="Loyalist Sabatons"}
		
    sets.precast.WS['Chant du Cygne'] = {main="Excalibur",ammo="Ginsen",
        head="Founder's Corona",neck="Fotia Gorget",ear1="Bladeborn Earring",ear2="Steelflash Earring",
        body="Founder's Breastplate",hands="Despair Finger Gauntlets",ring1="Aquasoul Ring",ring2="Aquasoul Ring",
        back="Atheling Mantle",waist="Fotia Belt",legs="Eschite Cuisses",feet="Loyalist Sabatons"}

    sets.precast.WS['Sanguine Blade'] = {main="Excalibur",ammo="Ginsen",
    ...
    sets.precast.WS['Atonement'] = {main="Excalibur",ammo="Iron Gobbet",
    ...
    sets.midcast.FastRecast = {main="Excalibur",ammo="Incantor Stone",
        head="Chevalier's Armet",neck="Twilight Torque",ear1="Loquacious Earring",ear2="Cassie Earring",
        body="Caballarius Surcoat +1",hands="Layline Gloves",ring1="Defending Ring",ring2="Vocane Ring",
        back="Shadow Mantle",waist="Sailfi Belt",legs="Homam Cosciales",feet="Odyssean Greaves"}
        
    sets.midcast.Enmity = {main="Excalibur",ammo="Angha Gem",
        head="Caballarius Coronet +1",neck="Unmoving Collar",ear1="Creed Earring",ear2="Cassie Earring",
        body="Chev. Cuirass",hands="Caballarius Gauntlets +1",ring1="Defending Ring",ring2="Vocane Ring",
        back="Weard Mantle",waist="Goading Belt",legs="Caballarius Breeches +1",feet="Chev. Sabatons +1"}

    sets.midcast.Flash = set_combine(sets.midcast.Enmity, {legs="Enif Cosciales"})
    
    sets.midcast.Stun = sets.midcast.Flash
    
    sets.midcast.Cure = {main="Excalibur",ammo="Iron Gobbet",
        head="Adaman Barbuta",neck="Invidia Torque",ear1="Hospitaler Earring",ear2="Nourishing Earring",
        body="Souveran Cuirass",hands="Souv. Handschuhs",ring1="Kunaji Ring",ring2="Vocane Ring",
        back="Fierabras's Mantle",waist="Chuq'aba Belt",legs="Reverence Breeches +1",feet="Souveran Schuhs"}

    sets.midcast['Enhancing Magic'] = {ammo="Incantor Stone",
        head="Cizin Helm",neck="Twilight Torque",ear1="Loquacious Earring",ear2="Cassie Earring",
        body="Caballarius Surcoat +1",hands="Souv. Handschuhs",ring1="Defending Ring",ring2="Vocane Ring",
        back="Shadow Mantle",waist="Sailfi Belt",legs="Homam Cosciales",feet="Souveran Schuhs"}
    ...
    -- Idle sets
    sets.idle = {main="Excalibur",sub="Ochain",ammo="Angha Gem",
        head="Reverence Coronet +1",neck="Twilight Torque",ear1="Creed Earring",ear2="Cassie Earring",
        body="Souveran Cuirass",hands="Souv. Handschuhs",ring1="Defending Ring",ring2="Vocane Ring",
        back="Shadow Mantle",waist="Flume Belt",legs="Caballarius Breeches +1",feet="Souveran Schuhs"}

    sets.idle.Town = {main="Excalibur",sub="Ochain",ammo="Angha Gem",
        head="Reverence Coronet +1",neck="Twilight Torque",ear1="Creed Earring",ear2="Cassie Earring",
        body="Souveran Cuirass",hands="Souv. Handschuhs",ring1="Defending Ring",ring2="Vocane Ring",
        back="Shadow Mantle",waist="Flume Belt",legs="Caballarius Breeches +1",feet="Souveran Schuhs"}
    
    sets.idle.Weak = {main="Excalibur",sub="Ochain",ammo="Iron Gobbet",
    ...
    sets.defense.PDT = {main="Excalibur",sub="Ochain",ammo="Angha Gem",
        head="Reverence Coronet +1",neck="Twilight Torque",ear1="Creed Earring",ear2="Cassie Earring",
        body="Souveran Cuirass",hands="Souv. Handschuhs",ring1="Defending Ring",ring2="Vocane Ring",
        back="Repulse Mantle",waist="Nierenschutz",legs="Caballarius Breeches +1",feet="Souveran Schuhs",sub="Ochain"}
    sets.defense.HP = {main="Excalibur",sub="Ochain",ammo="Iron Gobbet",
    ...
    sets.defense.Reraise = {main="Excalibur",sub="Ochain",ammo="Iron Gobbet",
    ...
    sets.defense.Charm = {main="Excalibur",sub="Ochain",ammo="Iron Gobbet",
    ...
    sets.defense.MDT = {main="Excalibur",sub="Aegis",ammo="Demonry Stone",
        head="Reverence Coronet +1",neck="Twilight Torque",ear1="Creed Earring",ear2="Cassie Earring",
        body="Caballarius Surcoat +1",hands="Reverence Gauntlets +1",ring1="Defending Ring",ring2="Shadow Ring",
        back="Mollusca Mantle",waist="Nierenschutz",legs="Reverence Breeches +1",feet="Caballarius Leggings +1",sub="Aegis"}
    ...
    sets.engaged = {main="Excalibur",ammo="Ginsen",
        head="Despair Helm",neck="Twilight Torque",ear1="Bladeborn Earring",ear2="Steelflash Earring",
        body="Founder's Breastplate",hands="Despair Finger Gauntlets",ring1="Defending Ring",ring2="Vocane Ring",
        back="Weard Mantle",waist="Kentarch",legs="Eschite Cuisses",feet="Odyssean Greaves"}

    sets.engaged.Acc = {main="Excalibur",ammo="Ginsen",
        head="Despair Helm",neck="Twilight Torque",ear1="Bladeborn Earring",ear2="Steelflash Earring",
        body="Founder's Breastplate",hands="Despair Finger Gauntlets",ring1="Defending Ring",ring2="Vocane Ring",
        back="Weard Mantle",waist="Kentarch",legs="Eschite Cuisses",feet="Odyssean Greaves"}

    sets.engaged.DW = {main="Excalibur",ammo="Ginsen",
        head="Despair Helm",neck="Twilight Torque",ear1="Bladeborn Earring",ear2="Steelflash Earring",
        body="Founder's Breastplate",hands="Despair Finger Gauntlets",ring1="Defending Ring",ring2="Vocane Ring",
        back="Weard Mantle",waist="Kentarch",legs="Eschite Cuisses",feet="Odyssean Greaves"}

    sets.engaged.DW.Acc = {main="Excalibur",ammo="Ginsen",
        head="Despair Helm",neck="Twilight Torque",ear1="Bladeborn Earring",ear2="Steelflash Earring",
        body="Founder's Breastplate",hands="Despair Finger Gauntlets",ring1="Defending Ring",ring2="Vocane Ring",
        back="Weard Mantle",waist="Kentarch",legs="Eschite Cuisses",feet="Odyssean Greaves"}
