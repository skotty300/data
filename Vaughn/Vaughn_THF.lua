...
function init_gear_sets()
    ...
    sets.buff['Sneak Attack'] = {ammo="Yetshila +1",
        head="Adhemar bonnet +1",neck="Asperity Necklace",ear1="Dudgeon Earring",ear2="Heartseeker Earring",
        body="Abnoba kaftan",hands="Skulker's armlets",ring1="Rajas Ring",ring2="Epona's Ring",
        back="Canny cape",waist="Patentia Sash",legs="Pillager's Culottes +1",feet="Herculean boots"}
    ...
    sets.buff['Trick Attack'] = {ammo="Yetshila +1",
        ...
        body="Abnoba kaftan",hands="Pillager's armlets +1",ring1="Petrov Ring",ring2="Epona's Ring",
        back="Canny cape",waist="Patentia Sash",legs="Pillager's Culottes +1",feet="Herculean boots"}
    ...
    sets.precast.Waltz = {ammo="Sonia's Plectrum",
        head="Whirlpool Mask",
        body="Pillager's Vest +1",hands="Qaaxo mitaines",ring1="Asklepian Ring",
    ...
    sets.precast.FC = {head="Haruspex Hat",ear1="Loquac. Earring",ear2="Etiolation earring",hands="Leyline Gloves",ring1="Prolix Ring",ring2="Weatherspoon ring",legs="Enif Cosciales"}
    ...
    sets.precast.WS = {ammo="Yetshila +1",
        ...
        body="Abnoba kaftan",hands="Adhemar Wrist. +1",ring1="Rajas Ring",ring2="Epona's Ring",
        back="Canny cape",waist="Fotia belt",legs="Meg. Chausses +1",feet="Herculean boots"}
    ...
    sets.precast.WS["Rudra's Storm"] = set_combine(sets.precast.WS, {head="Adhemar bonnet",ear1="Brutal Earring",ear2="Moonshade Earring"})
    ...
    sets.precast.WS['Aeolian Edge'] = {ammo="Jukukik Feather",
        ...
        body="Wayfarer Robe",hands="Qaaxo mitaines",ring1="Acumen Ring",ring2="Demon's Ring",
    ...
    sets.midcast.FastRecast = {
        head="Whirlpool Mask",neck="Baetyl Pendant",ear1="Loquac. Earring",ear2="Etiolation earring",
        body="Pillager's Vest +1",hands="Leyline gloves",
        back="Canny Cape",legs="Kaabnax Trousers",feet="Iuitl Gaiters +1"}

    -- Specific spells
    sets.midcast.Utsusemi = {
        head="Whirlpool Mask",neck="Baetyl Pendant",ear2="Loquacious Earring",
        body="Pillager's Vest +1",hands="Qaaxo mitaines",ring1="Beeline Ring",
        back="Canny Cape",legs="Kaabnax Trousers",feet="Iuitl Gaiters +1"}
    ...
    sets.idle = {ammo="Thew Bomblet",
        head="Adhemar bonnet +1",neck="Sanctity necklace",ear1="Infused earring",ear2="Etiolation earring",
        body="Adhemar jacket +1",hands="Adhemar wristbands +1",ring1="Sheltered Ring",ring2="Paguroidea Ring",
        back="Solemnity cape",waist="Flume Belt",legs="Meg. Chausses +1",feet="Pillager Poulaines"}
    ...
    sets.idle.Weak = {ammo="Thew Bomblet",
        head="Adhemar bonnet +1",neck="Sanctity necklace",ear1="Infused earring",ear2="Etiolation earring",
        body="Adhemar jacket +1",hands="Adhemar wristbands +1",ring1="Sheltered Ring",ring2="Paguroidea Ring",
        back="Canny cape",waist="Flume Belt",legs="Meg. Chausses +1",feet="Pillager Poulaines"}
    ...
    sets.defense.Evasion = {
        ...
        body="Qaaxo Harness",hands="Qaaxo mitaines",ring1="Defending Ring",ring2="Beeline Ring",
    ...
    sets.defense.PDT = {ammo="Iron Gobbet",
        ...
        body="Emet harness +1",hands="Qaaxo mitaines",ring1="Defending Ring",ring2=gear.DarkRing.physical,
        back="Iximulew Cape",waist="Flume Belt",legs="Pillager's Culottes +1",feet="Iuitl Gaiters +1"}

    sets.defense.MDT = {ammo="Demonry Stone",
        head="Pillager's Bonnet +1",neck="Twilight Torque",
        body="Emet harness +1",hands="Qaaxo mitaines",ring1="Defending Ring",ring2="Shadow Ring",
    ...
    sets.engaged = {ammo="Ginsen",
        head="Adhemar bonnet +1",neck="Lissome necklace",ear1="Dudgeon Earring",ear2="Heartseeker Earring",
        body="Adhemar jacket +1",hands="Plunderer's Armlets +1",ring1="Petrov Ring",ring2="Epona's Ring",
        back="Canny cape",waist="Windbuffet Belt +1",legs="Meg. Chausses +1",feet="Skulker's Poulaines"}
    sets.engaged.Acc = {ammo="Honed Tathlum",
        head="Adhemar bonnet +1",neck="Subtlety spectacles",ear1="Steelflash earring", ear2="Bladeborn earring",
        body="Adhemar jacket +1",hands="Adhemar wristbands +1",ring1="Petrov Ring",ring2="Epona's Ring",
        back="Canny cape",waist="Kentarch Belt",legs="Meg. Chausses +1",feet="Herculean boots"}
        
    -- Mod set for trivial mobs (Skadi+1)
    sets.engaged.Mod = {ammo="Thew Bomblet",
        head="Felistris Mask",neck="Asperity Necklace",ear1="Dudgeon Earring",ear2="Heartseeker Earring",
        body="Skadi's Cuirie +1",hands="Qaaxo mitaines",ring1="Rajas Ring",ring2="Epona's Ring",
    ...
    sets.engaged.Evasion = {ammo="Thew Bomblet",
        ...
        body="Qaaxo Harness",hands="Qaaxo mitaines",ring1="Beeline Ring",ring2="Epona's Ring",
        back="Canny Cape",waist="Patentia Sash",legs="Kaabnax Trousers",feet="Qaaxo Leggings"}
    sets.engaged.Acc.Evasion = {ammo="Honed Tathlum",
        head="Whirlpool Mask",neck="Ej Necklace",ear1="Dudgeon Earring",ear2="Heartseeker Earring",
        body="Pillager's Vest +1",hands="Qaaxo mitaines",ring1="Beeline Ring",ring2="Epona's Ring",
    ...
    sets.engaged.PDT = {ammo="Thew Bomblet",
        ...
        body="Emet Harness +1",hands="Qaaxo mitaines",ring1="Defending Ring",ring2="Epona's Ring",
